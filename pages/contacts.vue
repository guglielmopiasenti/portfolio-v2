...
<template>
  <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Send me a message!</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">Got a question or proposal, or just want
